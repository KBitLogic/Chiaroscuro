...
- Nearly every single color token is now registered!
...
1. Download the VSIX from the Visual Studio Marketplace or GitHub
2. Open the VSIX file with Microsoft Visual Studio Version Selector (Right click > Open With)
3. Activate the theme within Visual Studio (Tools > Theme > {Theme Name})
